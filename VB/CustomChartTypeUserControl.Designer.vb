...
'			Me.imageListBoxControl1.SelectedIndexChanged += New System.EventHandler(Me.imageListBoxControl1_SelectedIndexChanged);
			' 
			' imageCollection1
			' 
...
'			Me.Load += New System.EventHandler(Me.CustomChartTypeUserControl_Load);
